    ...
    <div class="container">
        <div class="col-md-9 technology-left">
            <div class="agileinfo">
                ...
                <h2 class="w3">Redis的使用</h2>
                <div class="single">
                    <img src="indexSource/images/sing-1.jpg" class="img-responsive" alt="">
                    <div class="b-bottom">
                        <h5 class="top">Redis是目前业界使用最广泛的内存数据存储</h5>

                        <p class="sub">相比memcached，Redis支持更丰富的数据结构，例如hashes, lists, sets等，同时支持数据持久化。</p>
                        <p class="sub">Redis还提供一些类数据库的特性，比如事务，HA，主从库</p>

                        <p>&nbsp</p>
                        <h3>如何使用</h3>
                        <p>&nbsp</p>
                        <p>1、引入spring-boot-starter-redis</p>
                        <p>2、在application.properties增加Redis的配置</p>
                        <p>3、使用</p>
                        ...
                        <h3>参考资料</h3>
                        <p>&nbsp </p>
                        <a href="https://www.cnblogs.com/ityouknow/p/5748830.html">redis使用</a>
                        <p>&nbsp </p>
