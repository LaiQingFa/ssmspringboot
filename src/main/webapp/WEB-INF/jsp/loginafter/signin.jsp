...
<section id="content" class="m-t-lg wrapper-md animated fadeInUp">
    <div class="container aside-xl">
        <a class="navbar-brand block" href="index.html"><span class="h1 font-bold">SpringBoot</span></a>
        <section class="m-b-lg">
            <header class="wrapper text-center">
                <strong>Sign in to get in touch</strong>
            </header>
            <form action=" sucessLogin">
                <div class="form-group">
                    <input  placeholder="账号" class="form-control rounded input-lg text-center no-border">
                </div>
                <div class="form-group">
                ...
                <a href="signup.html" class="btn btn-lg btn-info btn-block rounded">现在就加入我们</a>
            </form>
        </section>
    </div>
</section>
